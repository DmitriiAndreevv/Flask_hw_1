...
app = FastAPI()
templates = Jinja2Templates(directory="./Flask_hw_5/templates")
...
if __name__ == "__main__":
    uvicorn.run("taskmaster:app", host="127.0.0.1", port=5000, reload=True)

# uvicorn ht_05_firstViewOfFastAPI.taskmater:app --reload